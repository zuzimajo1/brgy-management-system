            ...
            <View style={styles.containertext}>
              ...
              <View style={styles.firstcontainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  offense and has no pending case(s) filled before the Lupong
              ...
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  <Text>{ClientSex === "Male" ? "he" : "she"}</Text> is willing
                  to give Prime Water Infrastructure Corportation an authority
                  to take the water whenever the land owner reclaims the land
                  where they live.
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
...
const DataFillOut = ({
  ...
  return (
    <Container fluid="true" style={styles.formcontainer}>
      ...
      />
      <AdditionInputs clientname={ClientName} lettername="Water Connection" />
    </Container>
  );
};

export default WaterConnectionDirect;
