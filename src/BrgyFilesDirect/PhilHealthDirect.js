            ...
            <View style={styles.containertext}>
              ...
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  <Text style={styles.clientname}>{ClientName}</Text> is the
                  correct name and refers to be one and of the same person with
                  the registered member of PhilHealthDirect (INDIGENT member
                  list), name{" "}
...
const DataFillOut = ({
  ...
  return (
    <Container fluid="true" style={styles.formcontainer}>
      ...
      />
      <AdditionInputs clientname={ClientName} lettername="PhilHealth" />
    </Container>
  );
};

export default PhilHealthDirect;
