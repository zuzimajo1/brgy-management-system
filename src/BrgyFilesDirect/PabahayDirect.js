            ...
            <View style={styles.containertext}>
              ...
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  <Text style={styles.textuppercase}>{ClientName}</Text> is a
                  resident in this barangay for <Text>{ClientInfo}</Text> years
                  up to present.
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
  ...
  return (
    <Container fluid="true" style={styles.formcontainer}>
      ...
      <TextInput
        ...
        radius="sm"
        placeholder="ex. to support the transaction for the PabahayDirect sa Bayan"
        onChange={(e) => setClientPurpose(e.currentTarget.value)}
      />
      <AdditionInputs clientname={ClientName} lettername="Pabahay" />
    </Container>
  );
};

export default PabahayDirect;
