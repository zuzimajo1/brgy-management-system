...
const ChedScholarDirect = () => {
  ...
  return (
    <Container fluid="true" className={classes.root}>
      <Text style={styles.maintitle}>CHED Scholar</Text>
            ...
            <View style={styles.containertext}>
              ...
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  has never been convicted from any crime against property,
                  Barangay Ordinance or any crime involving moral turpitude as
                  per records in this Barangay and one of the Indigent families
                  in this Barangay.
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  above-mentioned person to support the transaction to{" "}
                  <Text style={styles.textregular}>
                    COMMISSION ON HIGHER EDUCATION (CHED) for SCHOLARSHIP
                  </Text>
                  .
                </Text>
              </View>
...
const DataFillOut = ({
  ...
  return (
    <Container fluid="true" style={styles.formcontainer}>
      ...
      />
      <AdditionInputs clientname={ClientName} lettername="Ched Scholar" />
    </Container>
  );
};

export default ChedScholarDirect;
