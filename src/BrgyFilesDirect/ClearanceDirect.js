...
const ClearanceDirect = () => {
  ...
  return (
    <Container fluid="true" className={classes.root}>
      <Text style={styles.maintitle}>Clearance</Text>
...
const MyDocuments = ({ singleperson, ClientAge, ClientPurpose,ClientName, 
  ClientSex, 
  ClientCivilStatus, 
  ClientCitizenship, 
  ClientAddress  }) => {
            ...
            <View style={styles.containertext}>
              ...
              <View style={styles.firstcontainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  Citizen, a resident of <Text style={styles.textCapitalize}>{ClientAddress}</Text>,
                  Barangay Luna, Surigao City, is known to me to be a person
                  with good moral character and good social standing in the
                  community.
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  <Text style={styles.textlowercase}>
                    {ClientSex === "Male" ? "he" : "she"}
                  </Text>{" "}
                  has never been charged in any kind of offense and has no
                  pending case(s) filed before the Lupong Tagapamayapa in this
                  Barangay, either civil or criminal up to present.
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
...
const DataFillOut = ({ClientName, setClientAge, setClientPurpose,setClientName, setClientCitizenship, setClientCivilStatus, setClientSex, setClientAddress }) => {
  return (
    <Container fluid="true" style={styles.formcontainer}>
      ...
      />
      <AdditionInputs clientname={ClientName} lettername="Clearance" />
    </Container>
  );
};

export default ClearanceDirect;