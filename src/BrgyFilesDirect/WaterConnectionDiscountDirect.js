...
const WaterConnectionDiscountDirect = () => {
  ...
  return (
    <Container fluid="true" className={classes.root}>
      <Text style={styles.maintitle}>Brgy Certification LCR</Text>
            ...
            <View style={styles.containertext}>
              ...
              <View style={styles.firstcontainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  Luna, Surigao City, is known to me to be a person with good
                  moral character and good social standing in the community.
                </Text>
              </View>
              ...
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  above-mentioned person as a{" "}
                  <Text style={styles.textregular}>
                    requirement to avail Senior Citizens discount to Surigao
                    Metropolitan Water District (DSWD)
                  </Text>
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
...
const DataFillOut = ({
  ...
  return (
    <Container fluid="true" style={styles.formcontainer}>
      ...
      <AdditionInputs
        clientname={ClientName}
        lettername="Water Connection Discount"
      />
    </Container>
  );
};

export default WaterConnectionDiscountDirect;
