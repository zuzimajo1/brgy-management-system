...
const CertificationLowIncomeDirect = () => {
  ...
  return (
    <Container fluid="true" className={classes.root}>
      <Text style={styles.maintitle}>Low Income</Text>
  ...
  return (
    <Container fluid="true" style={styles.formcontainer}>
      ...
      <TextInput
        ...
        radius="sm"
        placeholder="ex. a Pastor and has a Church Allowance of eight thousand (P8,000.00) pesos only"
      ...
      />
      <AdditionInputs clientname={ClientName} lettername="Low Income" />
    </Container>
  );
};

export default CertificationLowIncomeDirect;
