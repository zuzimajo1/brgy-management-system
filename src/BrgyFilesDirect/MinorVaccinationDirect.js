              ...
              <View style={styles.wrapper}>
                ...
                {FourthChildName && (
                  <View style={styles.contenttext}>
                    ...
                    <Text style={styles.marginTopText}>
                      {FourthChildBirthdate} YEARS OLD
                    </Text>
                    <Text style={styles.marginTopText}>{FourthChildAge}</Text>
                  </View>
                )}
                {FifthChildName && (
                  <View style={styles.contenttext}>
                    ...
                    <Text style={styles.marginTopText}>
                      {FifthChildBirthdate} YEARS OLD
                    </Text>
                    <Text style={styles.marginTopText}>{FifthChildAge}</Text>
                  </View>
                )}
              </View>
