            ...
            <View style={styles.containertext}>
              ...
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  has never been convicted from any crime against property, Barangay Ordinance or any crime involving moral turpitude as per records{" "}
                  in this Barangay and one of the Indigent families in this Barangay.
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  <Text style={styles.textregular}>COMMISSION ON HIGHER EDUCATION (CHED) for SCHOLARSHIP</Text>.
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
