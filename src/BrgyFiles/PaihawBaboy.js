              ...
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  <Text style={styles.textregular}>
                    SLAUGHTERHOUSE at Barangay Poctoy, Surigao City.
                  </Text>
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
...
const DataFillOut = ({ setClientInfo, setClientAge, Clientfullname }) => {
  return (
    <Container fluid="true" style={styles.formcontainer}>
      ...
      />
      <AdditionInputs clientname={Clientfullname} lettername="Paihaw Baboy" />
    </Container>
  );
};


export default PaihawBaboy;
