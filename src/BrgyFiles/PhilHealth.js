...
const PhilHealth = () => {
   ...
   return (
     <Container fluid="true" className={classes.root}>
       <Text style={styles.maintitle}>PhilHealth</Text>
...
const MyDocuments = ({ singleperson, ClientAge, ClientPIN }) => {
  const now = new Date();
            ...
            <View style={styles.containertext}>
              ...
              <View style={styles.firstcontainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  <Text style={styles.clientname}>
                    {`${singleperson?.firstname} ${singleperson?.middlename} ${singleperson?.lastname}`}
                  </Text>
              ...
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  is the correct name and refers to be one and of the same
                  person with the registered member of PhilHealth (INDIGENT
                  member list), name{" "}
                  <Text style={styles.textuppercase}>{`${singleperson?.firstname} ${singleperson?.middlename} ${singleperson?.lastname}`}</Text>
                  , identification Number (PIN) <Text>{ClientPIN}</Text>.
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
                <Text style={styles.textfirstparag}>
                  ...
                  above-mentioned person, to support the transaction{" "}
                  <Text style={styles.textregular}>for PHILHEALTH RECORD</Text>
                  .
                </Text>
              </View>
              <View style={styles.marginTopContainer}>
